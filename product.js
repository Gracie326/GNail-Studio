// ---------- PRODUCT DATABASE ----------
    const products = [
        { id: 1, name: "Pink Acrylic set", description: "dfhfhfghf", brand: "GNail studio", price: 40, originalPrice: 60, discount: "26%", image: "productimages/n1.jpeg" },
        { id: 2, name: "Nude gel polish",  description: "dfhfhfghf", brand: "Gnail studio", price: 55, originalPrice: 85, discount: "35%", image: "productimages/n4.jpeg" },
        { id: 3, name: "Pink set",  description: "dfhfhfghf", brand: "Zara Thrift", price: 32, originalPrice: 50, discount: "36%", image: "productimages/n3.jpeg" },
        { id: 4, name: "Brown Nail set",  description: "dfhfhfghf", brand: "Nike Vintage", price: 70, originalPrice: 110, discount: "36%", image: "productimages/n5.jpeg" },
        { id: 5, name: "Pink Nail Set", description: "dfhfhfghf", brand: "Nike Vintage", price: 70, originalPrice: 110, discount: "36%", image: "productimages/n2.jpeg" },
        { id: 6, name: "Pink Nail Set", description: "dfhfhfghf", brand: "Nike Vintage", price: 70, originalPrice: 110, discount: "36%", image: "productimages/n2.jpeg" }
         ];
    ...
    if (checkoutForm) {
        checkoutForm.addEventListener('submit', function(e) {
            ...
            const body = `Hello GNail Studio,\n\nI would like to place an order:\n\n${orderDetails}\n\nTotal: ₵${totalOrder}\n\nMy details:\n- Name: ${name}\n- Email: ${email}\n- Address: ${address}\n- Phone: ${phone}\n\nPlease confirm.`;
            const mailtoLink = `mailto:Ofeibeagrace3@gmail.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`;
